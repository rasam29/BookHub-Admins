package com.example.rasam.bookhubadmins.historyManager.view.deleted;
...
public class DeletedHistoryActivity extends ParentActivity<HistoryView,HistoryPresenter> implements HistoryView{
    @Override
